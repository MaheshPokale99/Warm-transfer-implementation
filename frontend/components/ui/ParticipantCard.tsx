...
const ParticipantCard: React.FC<ParticipantCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className={`bg-zinc-800/50 border border-zinc-700/30 rounded-lg p-4 transition-all duration-200 hover:border-zinc-600/50 ${
        isSpeaking ? 'ring-1 ring-green-500/30' : ''
      } ${className}`}
    >
